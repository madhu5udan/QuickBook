  ...
  return nowPlayingMovies.length > 0 ? (
    <>
          ...
          {nowPlayingMovies.map((movie) => (
            ...
            >
              ...
              {selectMovie === movie.id && (
                <div className="absolute top-2 right-2 flex items-center justify-between bg-primary h-6 w-6 rounded">
      ...
      <div className="mt-6">
        ...
        <div className="inline-flex items-center gap-5 border border-gray-600 p-1 pl-3">
      ...
      {Object.keys(dateTimeSelections).length > 0 && (
        <div className="mt-6">
          ...
          <ul className="space-y-3">
            {Object.entries(dateTimeSelections).map(([date, times]) => (
              <li key={date}>
